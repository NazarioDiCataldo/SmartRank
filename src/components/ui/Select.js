...
const Select = ({name, dataRequired = false, dataName = '', dataValidation = '',className = '', onChange = () => {}}, children) => {
    return DOM.div({className: twMerge(' ',className)},[
        ...
        className: 'select rounded-lg border h-full py-2 w-full border-white/10 focus:outline-0 focus:border-white/60 transition-all duration-300'}, 
    children),
