...
const HorizontalCard = ({id, className = '', href, cardOptions, reviewObj}) => {
    ...
    //Mi creo la card
    return DOM.a({id, href: `/catalogo/${href}`,className: 'flex w-[16rem] md:w-[23rem] h-full flex-shrink-0 items-center gap-3 py-5 px-4 rounded-2xl border-white/5 border-[1px] bg-gradient-to-br shadow-[0_0_12px_rgba(40,228,150,0.1)] hover:shadow-[0_0_16px_1px_rgba(40,228,150,0.15)] from-[rgba(40,228,150,15%)] hover:from-15% to-[rgba(255,255,255,5%)] hover:to-75% hover: scale-[1.02] hover:translate-y-[-2px] transition-all duration-300'}, [
